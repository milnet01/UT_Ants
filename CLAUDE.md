...
items. Else 5.
**Next:** `UTA-0016` (load a bundle and walk it). Before asking the user its
scope questions, read `docs/design.md` and bring a short set of concrete
choices. `UTA-0139` shipped 2026-09-14: each exit in ut-paths' per-map JSON
names what separates it from the start, and `UTA-0142` is the
disabled-teleporter gap it turned up. `UTA-0103`
