...
items. Else 5.
**Next:** `UTA-0175`, after `UTA-0176`
(magenta torch flames), which is in flight; `UTA-0174` (the camera kept
clear of every nearby surface) shipped 2026-09-17, green on the matrix.
Then
...
format 13 since `UTA-0165`, so a map baked before it must be baked again.
